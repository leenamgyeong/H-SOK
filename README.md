...
## IPv4와 IPv6를 사용하는 이유와 특징들에 대해서 적어보세요.
### 주소 개수가 너무 많아져서 IPv4 가 꽉차버림. 그래서 IPv6도 사용. 
* IPv4가 주소는 32비트. 약 40억개 정도. packets의 크기가 제한
* IPv6는 128비트, 개수는 거의 무한. packets의 크기가 제한 없음
### 루미너스
